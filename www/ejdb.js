...
module.exports = {
	...
	cordova.exec(successCallback, errorCallback, "EJDBPlugin", "init", [path]);
    },
	...
	cordova.exec(successCallback, errorCallback, "EJDBPlugin", "initializeCollectionWithName", [name, jsonObj]);	
    },
